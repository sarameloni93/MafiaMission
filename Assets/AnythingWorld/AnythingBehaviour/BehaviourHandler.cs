    ...
    public static class BehaviourHandler
    {
        public static void AddBehaviours(ModelData data)
        {
            ...
            if (data.parameters.setDefaultBehaviourPreset)
            {
                ...
                {
                    //Debug.Log(data.defaultBehaviourType);
                    if (Resources.LoadAll<DefaultBehaviourPreset>("")?.First()!=null)
                    {
                        var preset = Resources.LoadAll<DefaultBehaviourPreset>("").First();
                        TrySetBehaviour(data, preset);
                    }
                    else
                    {
