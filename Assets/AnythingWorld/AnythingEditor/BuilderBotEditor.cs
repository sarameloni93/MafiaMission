...
{
    public class BuilderBotEditor : AnythingCreatorEditor
    {
        ...
        internal static void Initialize()
        {
            ...
            if (AnythingSettings.HasAPIKey)
            {
                ...
                CloseWindowIfOpen<BuilderBotEditor>();
                var browser = GetWindow(typeof(BuilderBotEditor), false, "AI Creator");
        ...
        private void DrawBuilderBot()
        {
            ...
            float marginSize = DrawTextInputBox(e);
        ...
        private float DrawTextInputBox(Event e)
        {
            var marginSize = 0.1f;
            ...
            if (AnythingVoice.parsedCommand != null && AnythingVoice.parsedCommand.actions != null)
            {
                ...
                for (int actionIndex = 0; actionIndex < actions.Length; actionIndex++)
                {
                    ...
                    if (actionFoldouts[actionIndex])
                    {
                        ...
                        if (action.actionEnum == ActionSchema.change_habitat)
                        {
        ...
        private string GetHumanReadableAction(ActionSchema schema)
        {
